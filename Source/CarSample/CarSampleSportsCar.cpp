...
#include "CarSampleSportsCar.h"
#include "CarSampleSportsWheelFront.h"
#include "CarSampleSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarSampleSportsCar::ACarSampleSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarSampleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarSampleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarSampleSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarSampleSportsWheelRear::StaticClass();
